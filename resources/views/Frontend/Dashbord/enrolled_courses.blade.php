                ...
                <div class="col-12">
                    <div class="breadcrumb__content">
                        ...
                        <nav class="breadcrumb">
                            ...
                            <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                            <span property="itemListElement" typeof="ListItem">Enrolled Courses</span>
                        </nav>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="swiper-wrapper">
                                                        ...
                                                        <div class="courses__item courses__item-two shine__animate-item">
                                                            <div class="courses__item-thumb courses__item-thumb-two">
                                                                <a href="#0" class="shine__animate-link">
                                                                    <img src="/frontend/assets/img/courses/course_thumb01.jpg"
                                                                        alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="courses__item-content courses__item-content-two">
                                                                <ul class="courses__item-meta list-wrap">
                                                                    <li class="courses__item-tag">
                                                                        <a
                                                                            href="https://html.themegenix.com/skillgro/course.html">Development</a>
                                                                    </li>
                                                                </ul>
                                                                <h5 class="title"><a href="#0">Learning
                                                                        JavaScript With Imagination</a></h5>
                                                                <div class="courses__item-content-bottom">
                                                                    <div class="author-two">
                                                                        <a href="#0"><img
                                                                                src="/frontend/assets/img/courses/course_author001.png"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="courses__item courses__item-two shine__animate-item">
                                                            <div class="courses__item-thumb courses__item-thumb-two">
                                                                <a href="#0" class="shine__animate-link">
                                                                    <img src="/frontend/assets/img/courses/course_thumb02.jpg"
                                                                        alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="courses__item-content courses__item-content-two">
                                                                <ul class="courses__item-meta list-wrap">
                                                                    <li class="courses__item-tag">
                                                                        <a
                                                                            href="https://html.themegenix.com/skillgro/course.html">Design</a>
                                                                    </li>
                                                                </ul>
                                                                <h5 class="title"><a href="#0">The
                                                                        Complete Graphic Design for Beginners</a></h5>
                                                                <div class="courses__item-content-bottom">
                                                                    <div class="author-two">
                                                                        <a href="#0"><img
                                                                                src="/frontend/assets/img/courses/course_author002.png"
                                                                                alt="img">Wilson</a>
                                                                    </div>
                                                                    <div class="avg-rating">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="courses__item courses__item-two shine__animate-item">
                                                            <div class="courses__item-thumb courses__item-thumb-two">
                                                                <a href="#0" class="shine__animate-link">
                                                                    <img src="/frontend/assets/img/courses/course_thumb03.jpg"
                                                                        alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="courses__item-content courses__item-content-two">
                                                                <ul class="courses__item-meta list-wrap">
                                                                    <li class="courses__item-tag">
                                                                        <a
                                                                            href="https://html.themegenix.com/skillgro/course.html">Data
                                                                            Science</a>
                                                                    </li>
                                                                </ul>
                                                                <h5 class="title"><a href="#0">Learning
                                                                ...
                                                                <div class="courses__item-content-bottom">
                                                                    <div class="author-two">
                                                                        <a href="#0"><img
                                                                                src="/frontend/assets/img/courses/course_author003.png"
                                                                                alt="img">Warren</a>
                                                                    </div>
                                                                    <div class="avg-rating">
                                                                        <i class="fas fa-star"></i> (4.8 Reviews)
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="courses__item courses__item-two shine__animate-item">
                                                            <div class="courses__item-thumb courses__item-thumb-two">
                                                                <a href="#0" class="shine__animate-link">
                                                                    <img src="/frontend/assets/img/courses/course_thumb04.jpg"
                                                                        alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="courses__item-content courses__item-content-two">
                                                                <ul class="courses__item-meta list-wrap">
                                                                    <li class="courses__item-tag">
                                                                        <a
                                                                            href="https://html.themegenix.com/skillgro/course.html">Business</a>
                                                                    </li>
                                                                </ul>
                                                                <h5 class="title"><a href="#0">Financial
                                                                        Analyst Training & Investing Course</a></h5>
                                                                <div class="courses__item-content-bottom">
                                                                    <div class="author-two">
                                                                        <a href="#0"><img
                                                                                src="/frontend/assets/img/courses/course_author004.png"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="courses__item courses__item-two shine__animate-item">
                                                            <div class="courses__item-thumb courses__item-thumb-two">
                                                                <a href="#0" class="shine__animate-link">
                                                                    <img src="/frontend/assets/img/courses/course_thumb05.jpg"
                                                                        alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="courses__item-content courses__item-content-two">
                                                                <ul class="courses__item-meta list-wrap">
                                                                    <li class="courses__item-tag">
                                                                        <a
                                                                            href="https://html.themegenix.com/skillgro/course.html">Mathematic</a>
                                                                    </li>
                                                                </ul>
                                                                <h5 class="title"><a href="#0">Learning
                                                                        JavaScript With Imagination</a></h5>
