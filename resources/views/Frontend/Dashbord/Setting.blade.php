                ...
                <div class="col-12">
                    <div class="breadcrumb__content">
                        ...
                        <nav class="breadcrumb">
                            ...
                            <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                            <span property="itemListElement" typeof="ListItem">Setting</span>
                        </nav>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="itemOne-tab-pane" role="tabpanel"
                                            ...
                                            <div class="instructor__cover-bg"
                                                data-background="/frontend/assets/img/bg/student_bg.jpg">
                                                <div class="instructor__cover-info">
                                                    <div class="instructor__cover-info-left">
                                                        <div class="thumb">
                                                            <img src="/frontend/assets/img/courses/details_instructors02.jpg"
                                                                alt="img">
                                                        </div>
                                                    ...
                                                    <div class="instructor__cover-info-right">
                                                        <a href="#0" class="btn btn-two arrow-btn">Edit
                                                            Cover Photo</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="instructor__profile-form-wrap">
                                                <form action="#0" class="instructor__profile-form">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-grp">
