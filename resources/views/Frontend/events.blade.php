                ...
                <div class="row justify-content-center">
                        ...
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb01.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">The Accessible Target Sizes Cheatsheet</a>
                                </h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb02.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">Aewe Creating Futures Through
                                        Technology</a></h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb03.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">Exactly How Technology Can Make Reading</a>
                                </h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb04.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">Learning JavaScript With Imagination</a>
                                </h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb05.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">Make Your Magnificent May 2023
                                        Edition</a></h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb06.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">Accessible Target Sizes Cheatsheet</a>
                                </h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb07.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">Color mechanics that he came up with
                                        during</a></h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="event__item shine__animate-item">
                            <div class="event__item-thumb">
                                <a href="#0" class="shine__animate-link"><img
                                        src="/frontend/assets/img/events/event_thumb08.jpg" alt="img"></a>
                            </div>
                            <div class="event__item-content">
                                <span class="date">25 June, 2024</span>
                                <h2 class="title"><a href="#0">How To Design Effective User
                                        Onboarding</a></h2>
                                <a href="https://maps.google.com/maps" class="location" target="_blank"><i
