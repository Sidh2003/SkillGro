                    ...
                    <div class="shop-details-images-wrap d-flex gap-3">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                tabindex="0">
                                <a href="/frontend/assets/img/shop/shop_img01.jpg" class="popup-image">
                                    <img src="/frontend/assets/img/shop/shop_img01.jpg" alt="img">
                                </a>
                            </div>
                            <div class="tab-pane" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                                tabindex="0">
                                <a href="/frontend/assets/img/shop/shop_img02.jpg" class="popup-image">
                                    <img src="/frontend/assets/img/shop/shop_img02.jpg" alt="img">
                                </a>
                            </div>
                            <div class="tab-pane" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab"
                                tabindex="0">
                                <a href="/frontend/assets/img/shop/shop_img03.jpg" class="popup-image">
                                    <img src="/frontend/assets/img/shop/shop_img03.jpg" alt="img">
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="shop-details-content">
                        ...
                        <div class="shop-details-qty">
                            ...
                            <a href="#0" class="cart-btn btn">Add To Cart</a>
                            <a href="#0" class="wishlist-btn"><i class="far fa-heart"></i></a>
                        </div>
